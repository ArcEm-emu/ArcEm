...
typedef signed short int SoundData;
...
#ifdef SOUND_SUPPORT
extern unsigned long Sound_HostRate; /* Rate of host sound system, in 1/1024 Hz. Must be set by host on init. */
...
*/
extern SoundData *Sound_GetHostBuffer(long *destavail);
...
*/
extern void Sound_HostBuffered(SoundData *buffer,long numSamples);
#endif
